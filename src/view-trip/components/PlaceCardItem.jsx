...
function PlaceCardItem({place}) {
  ...
  return (
    ...
    <div className='border rounded-xl p-3 mt-2 flex gap-5  hover:scale-105 transition-all hover: shadow-neutral-900 shadow-md cursor-pointer'>
      <img src={photoUrl?photoUrl: "/NewHotel.jpg"} 
      ...
      <div>
        ...
        <h2 className='mt-2'>🎫{place.ticket_pricing} <Button className='max-h-6'><FaLocationDot /></Button></h2>
      </div>
    </div>
    </Link>
  )
