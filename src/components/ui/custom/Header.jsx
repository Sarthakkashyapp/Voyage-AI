...
function Header() {
  ...
  return (
    <div className='p-3 shadow-sm flex justify-between items-center px-5 bg-gray-200 gap-16'>
      <img src='/Orange.png' className='h-[40px] w-[160px] object-cover rounded-md'/>
      <div >
