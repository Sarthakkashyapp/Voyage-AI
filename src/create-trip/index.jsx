    ...
    <div className='sm:px-10 md:px-32 lg:px-56 xl:px-72 px-5 mt-10'>
      ...
      <div className='mt-20 flex flex-col gap-10'>
        ...
        <div>
          ...
          {SelectBudgetOptions.map((item,index)=>(
            ...
            className={`p-4 border cursor-pointer rounded-lg hover:shadow-gray-900 shadow-lg
        ...
        <div>
          ...
          {SelectTravelList.map((item,index)=>(
            ...
            className={`p-4 border rounded-lg cursor-pointer hover:shadow-gray-900 shadow-lg
      ...
      <div className='my-10 justify-end flex'>
        <Button 
          ...
          {loading?
          <FaTruckLoading className='h-7 w-7 animate-spin'/>:'Generate Trip'
        }
          </Button>
      </div>
